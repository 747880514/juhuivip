...
Page({
    ...
    submit: function() {
        ...
        i.data.posting || ("" != r.realname && r.realname ? "" != r.mobile && r.mobile ? "" != r.city && r.city ? !(i.data.street.length > 0) || "" != r.street && r.street ? "" != r.address && r.address ? r.datavalue ? (r.id = i.data.id, 
        i.setData({
            posting: !0
        ...
        })) : a.toast(i, "地址数据出错，请重新选择") : a.toast(i, "请填写详细地址") : a.toast(i, "请选择所在街道") : a.toast(i, "请选择所在地区") : a.toast(i, "请填写联系电话") : a.toast(i, "请填写收件人"));
    },
    onChange: function(t) {
