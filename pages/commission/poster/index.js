...
Page({
    data: {
        ...
        index: 0,
        errMsg: "",
        check: "https://static.btaeo.cn/static/images/check.png",
        posterArr: []
    },
    onLoad: function() {
        var t = this;
        ...
        wx.getSetting({
            success: function(e) {
                e.authSetting["scope.writePhotosAlbum"] ? (wx.showLoading({
                    ...
                    wx.hideLoading();
                }, 1e3), console.log(t.data.posterArr[t.data.index].poster), wx.downloadFile({
    ...
    requestImg: function(t) {
        ...
        i.setData({
            ...
            console.log(e), 0 == e.error ? (s[t].thumb = e.thumb, s[t].poster = e.poster, i.setData({
                posterArr: s
            })) : a.toast(i, "保存图片失败");
        });
    },
