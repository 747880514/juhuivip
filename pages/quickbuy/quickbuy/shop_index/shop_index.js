...
Page({
    ...
    onLoad: function(t) {
        ...
        i.setData({
            ...
            if (i.data.main.advs) {
                if (i.data.main.advs.length > 0) var a = [ 180 ], d = 180;
            } else var a = [ 0 ], d = 0;
            for (o = 0; o < i.data.main.group.length; o++) i.data.main.goodsArr[i.data.main.group[o].type] && (d = d + 98 * i.data.main.goodsArr[i.data.main.group[o].type].length + 66, 
            a.push(d), i.setData({
                arrscroll: a
            }));
        });
    ...
    scrollfn: function(t) {
        for (var a = this, e = 0; e < a.data.arrscroll.length; e++) if (Math.abs(t.detail.scrollTop - a.data.arrscroll[e]) < 26) {
