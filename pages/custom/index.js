...
Page((e = {
    ...
    e.onPlay(function() {
      var t = setInterval(function() {
        var i = e.currentTime / e.duration * 100 + "%",
          o = Math.floor(Math.ceil(e.currentTime) / 60),
          n = (Math.ceil(e.currentTime) % 60 / 100).toFixed(2).slice(-2),
          r = Math.ceil(e.currentTime);
        o < 10 && (o = "0" + o);
        var d = o + ":" + n,
          u = s.data.audios;
    ...
    var o = t.currentTarget.dataset.audio,
      n = t.currentTarget.dataset.time,
      r = t.currentTarget.dataset.pausestop,
      d = t.currentTarget.dataset.loopplay;
