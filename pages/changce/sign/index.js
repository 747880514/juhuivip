...
Page({
  ...
  getList: function () {
    ...
    a.loading(),
      ...
      a.get("changce/sign/get_list", { year: t.data.yearShow, month: t.data.monthShow}, function (b) {
      a.hideLoading();
      if (!b.member) {
        a.alert(b.error);
        //wx.navigateBack();
  ...
  dosign: function (date){
    var t = this;
    a.post("changce/sign/dosign", { date: date }, function (b) {
      if (!b.success) {
        a.alert(b.error);
        //wx.navigateBack();
        return false;
  ...
  getCredit: function (b) {
    ...
    var e = b.currentTarget.dataset.day,
      ...
      a.post("changce/sign/doreward", { type:1, day: e }, function (b) {
      if (!b.success) {
        a.alert(b.error);
        //wx.navigateBack();
        return false;
