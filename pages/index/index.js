...
var a, e, o = getApp(),
  i = o.requirejs("core"),
  s = o.requirejs("wxParse/wxParse"),
  n = o.requirejs("biz/diypage"),
  r = o.requirejs("biz/diyform"),
  d = o.requirejs("biz/goodspicker"),
  c = (o.requirejs("foxui"),
    o.requirejs("jquery"));
...
Page((e = {
    ...
    onLoad: function(t) {
      ...
      setTimeout(function() {
          ...
          if (a.getDiypage(t), void 0 != a.data.startadv && "" != a.data.startadv) {
            ...
            if (1 == e.showtype) {
              var s = 1e3 * e.showtime * 60,
                n = o.getCache("startadvtime"),
                r = +new Date(),
                d = !0;
              a.setData({
                adveradmin: !0
    ...
    //   var t = this;
    //   i.get("seckill/get_list", {}, function (e) {
    //       t.setData({
    //         rooms: e.rooms,
  ...
  t(e, "cancelclick", function() {
    ...
    var a = this,
      e = a.data.diypages,
      o = (e.items, t.currentTarget.dataset.id, t.currentTarget.dataset.url),
    ...
    c.each(o.items, function(t, s) {
      if (t == e)
        if (void 0 == s.status || "" == s.status) {
          if (-1 != s.data[0].linkurl.indexOf("stores")) d = "stores";
          else d = "goods";
          var n = s.data[0].linkurl,
            r = s.data[0].data.length;
          i.get("diypage/getInfo", {
            dataurl: n,
            num: r,
            paramsType: d
          ...
          if (-1 != s.data[s.status].linkurl.indexOf("stores")) d = "stores";
          else var d = "goods";
          var n = s.data[s.status].linkurl,
            r = s.data[s.status].data.length;
          i.get("diypage/getInfo", {
            dataurl: n,
            num: r
          }, function(t) {
